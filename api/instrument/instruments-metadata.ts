// Downloaded from  https://github.com/Leo4815162342/dukascopy-tools/blob/master/packages/dukascopy-node/src/config/instruments-metadata.ts
...
export const instrumentMetaData: InstrumentMetaData = {
  aususd: {
    name: 'A.US/USD',
